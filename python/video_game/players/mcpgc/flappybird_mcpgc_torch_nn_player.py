...
class FlappyBirdMCPGCTorchNNModel(mcpgc_torch_nn_model.MCPGCTorchNNModel):
...
class FlappyBirdMCPGCTorchNNPlayer(model_player.ModelPlayer):
    def create_model(self, state):
        return FlappyBirdMCPGCTorchNNModel(state)
