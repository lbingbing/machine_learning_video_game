...
class BombManMCPGCTorchNNModel(mcpgc_torch_nn_model.MCPGCTorchNNModel):
...
class BombManMCPGCTorchNNPlayer(model_player.ModelPlayer):
    def create_model(self, state):
        return BombManMCPGCTorchNNModel(state)
