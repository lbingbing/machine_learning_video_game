...
class SnakeMCPGCTorchNNModel(mcpgc_torch_nn_model.MCPGCTorchNNModel):
...
class SnakeMCPGCTorchNNPlayer(model_player.ModelPlayer):
    def create_model(self, state):
        return SnakeMCPGCTorchNNModel(state)
