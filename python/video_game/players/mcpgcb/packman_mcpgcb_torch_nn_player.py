...
class PackManMCPGCBTorchNNModel(mcpgcb_torch_nn_model.MCPGCBTorchNNModel):
...
class PackManMCPGCBTorchNNPlayer(model_player.ModelPlayer):
    def create_model(self, state):
        return PackManMCPGCBTorchNNModel(state)
