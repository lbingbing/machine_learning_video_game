...
class SnakeMCPGCBTorchNNModel(mcpgcb_torch_nn_model.MCPGCBTorchNNModel):
    def create_network(self, state):
        return Network(state)

class SnakeMCPGCBTorchNNPlayer(model_player.ModelPlayer):
    def create_model(self, state):
        return SnakeMCPGCBTorchNNModel(state)
