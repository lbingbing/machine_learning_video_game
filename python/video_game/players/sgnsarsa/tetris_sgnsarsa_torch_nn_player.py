...
class TetrisSGNSarsaTorchNNModel(sgnsarsa_torch_nn_model.SGNSarsaTorchNNModel):
    def create_network(self, state):
        return Network(state)

class TetrisSGNSarsaTorchNNPlayer(model_player.ModelPlayer):
    def create_model(self, state):
        return TetrisSGNSarsaTorchNNModel(state)
