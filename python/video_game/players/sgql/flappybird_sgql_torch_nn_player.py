...
class FlappyBirdSGQLTorchNNModel(sgql_torch_nn_model.SGQLTorchNNModel):
    def create_network(self, state):
        return Network(state)

class FlappyBirdSGQLTorchNNPlayer(model_player.ModelPlayer):
    def create_model(self, state):
        return FlappyBirdSGQLTorchNNModel(state)
