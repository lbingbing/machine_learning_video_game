...
class BombManGMCCTorchNNModel(gmcc_torch_nn_model.GMCCTorchNNModel):
    def create_network(self, state):
        return Network(state)

class BombManGMCCTorchNNPlayer(model_player.ModelPlayer):
    def create_model(self, state):
        return BombManGMCCTorchNNModel(state)
