...
class SnakeNActorCriticTorchNNModel(nactorcritic_torch_nn_model.NActorCriticTorchNNModel):
...
class SnakeNActorCriticTorchNNPlayer(model_player.ModelPlayer):
    def create_model(self, state):
        return SnakeNActorCriticTorchNNModel(state)
