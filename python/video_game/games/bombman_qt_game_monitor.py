...
class BombManGameMonitorWidget(qt_game_monitor.GameMonitorWidget):
    ...
    def get_state_update_interval(self):
        return bombman_qt_game_utils.get_state_update_interval(False)

    def draw_canvas(self, painter):
        bombman_qt_game_utils.draw_canvas(self.state, self.unit_size, painter)

qt_game_monitor.main(BombManGameMonitorWidget)
